            ...
            <div class="header-top">
                ...
                <div class="container">
                    ...
                    <ul class="nav-top-right tyrion-nav">
                        ...
                        <li><a href="/login"><i class="fa fa-user" aria-hidden="true"></i>Register / Sign in</a></li>
                            ...
                            <div class="header-menu header-menu-resize">
                                ...
                                <ul class="header-nav tyrion-nav">
                                    ...
                                    <li class="menu-item-has-children arrow">
                                        ...
                                        <ul class="submenu parent-megamenu">
                                            <li class="menu-item">
                                                <a href="/grid-product">Grid Product</a>
                                            </li>
                                            <li class="menu-item">
                                                <a href="/list-product">List Product</a>
                                            </li>
                                            <li class="menu-item">
                                                <a href="/list-product-right">List Product Right</a>
                                            </li>
                                            <li class="menu-item">
                                                <a href="/grid-product-right">Grid Product Right</a>
                                            </li>
                                            <li class="menu-item">
                                                <a href="/detail">Detail Product</a>
                                            </li>
                                        </ul>
...
<!-- Mirrored from ledthanhdat.vn/tyrion/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 23 Jun 2019 05:11:53 GMT -->
</html>