        ...
        <div class="page-container">
                ...
                <ul class="x-navigation">
                    ...
                    <li class="xn-openable active">
                        ...
                        <ul>
                            ...
                            <li class="active"><a href="ui-portlet.html"><span class="fa fa-th"></span> Portlet</a></li>
            ...
            <div class="page-content sortableContent" id="grid_content_1">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">Portlet</li>
                </ul>
                <!-- END BREADCRUMB -->
                
                <!-- PAGE TITLE -->
                <div class="page-title">                    
                    <h2><span class="fa fa-arrow-circle-o-left"></span> Portlet</h2>
                </div>
                <!-- END PAGE TITLE -->                
